import {Controller, Get, ParseArrayPipe, Query, Request, UseGuards} from '@nestjs/common';
...
export class NewsController {
    ...
    async getLatestNews(
        ...
        if (news.length === 0) return await this.pressReviewService.getUserNewsFromKeyWords(req.user);
