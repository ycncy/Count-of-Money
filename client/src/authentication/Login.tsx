...
export default function Login() {
    return (
        <section className=" bg-gradient-to-r accent-fuchsia-900 to-fuchsia-950 ">
            <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0 h-14 bg-gradient-to-r from-violet-500 to-fuchsia-600">
                <div
